...
class DataTable2DemoState extends State<DataTable2Demo> {
  ...
  // late DessertDataSourceAsync _dessertsDataSourceAsync;
  bool _initialized = false;
  bool showCustomArrow = true;
              ...
              columns: [
                ...
                DataColumn2(
                  ...
                  fixedWidth: getCurrentRouteOption(context) == fixedColumnWidth
                      ...
                      : null,
                  onSort: (columnIndex, ascending) =>
                      _sort<String>((d) => d.merchant, columnIndex, ascending),
                ),
                DataColumn2(
                  ...
                  onSort: (columnIndex, ascending) => _sort<String>(
                      (d) => d.formattedAmount, columnIndex, ascending),
                ),
                DataColumn2(
